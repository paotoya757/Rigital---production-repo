...
public class UnidadDeRedTest {
    ...
    public void setUpUrl() {
        driver.get(baseUrl + "/RigitalApp.web/unidadDeRed.html");
    }
     @Test
    public void testCrearMaquina() throws Exception {
        ...
        driver.findElement(By.id("name")).sendKeys("isc2.uniandes.edu.co/profesores");
        
        Thread.sleep(2000);
        
        driver.findElement(By.id("descripcion")).clear();
        driver.findElement(By.id("descripcion")).sendKeys("Espacio de unidad de red para profesores");
        ...
        driver.findElement(By.id("servidor")).sendKeys("isc2.uniandes.edu.co");
        
        Thread.sleep(2000);                
        
        driver.findElement(By.id("url")).clear();
        driver.findElement(By.id("url")).sendKeys("isc2.uniandes.edu.co/profesores");
        ...
        for (WebElement webElement : table) {
            ...
            if (elems.get(1).getText().equals("isc2.uniandes.edu.co/profesores") && elems.get(2).getText().equals("22/11/2014")
    ...
    public void testBuscarMaquina() throws Exception {
        ...
        driver.findElement(By.id("name")).sendKeys("uniandes");
        ...
        for (WebElement webElement : table) {
            List<WebElement> elems = webElement.findElements(By.xpath("td"));             
            success = success && elems.get(1).getText().contains("uniandes");                             
        }
