define(['controller/selectionController', 'model/cacheModel', 'model/softwareSalasMasterModel', 'component/_CRUDComponent', 'controller/tabController', 'component/softwareSalasComponent',
 ...
 problemaComponent) {
    App.Component._SoftwareSalasMasterComponent = App.Component.BasicComponent.extend({
        initialize: function() {
            var self = this;
            ...
            this.masterComponent = new SoftwareSalasComponent();
            ...
            Backbone.on(this.masterComponent.componentId + '-post-softwareSalas-create', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-post-softwareSalas-edit', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-pre-softwareSalas-list', function() {
                self.hideChilds();
            });
            ...
            Backbone.on(this.masterComponent.componentId + '-instead-softwareSalas-save', function(params) {
                ...
                self.model.save({}, {
                    success: function() {
                        Backbone.trigger(self.masterComponent.componentId + '-' + 'post-softwareSalas-save', {view: self, model : self.model});
                    },
    ...
    return App.Component._SoftwareSalasMasterComponent;
});