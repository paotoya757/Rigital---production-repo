define(['controller/selectionController', 'model/cacheModel', 'model/contenedorWebMasterModel', 'component/_CRUDComponent', 'controller/tabController', 'component/contenedorWebComponent',
 ...
 problemaComponent) {
    App.Component._ContenedorWebMasterComponent = App.Component.BasicComponent.extend({
        initialize: function() {
            var self = this;
            ...
            this.masterComponent = new ContenedorWebComponent();
            ...
            Backbone.on(this.masterComponent.componentId + '-post-contenedorWeb-create', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-post-contenedorWeb-edit', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-pre-contenedorWeb-list', function() {
                self.hideChilds();
            });
            ...
            Backbone.on(this.masterComponent.componentId + '-instead-contenedorWeb-save', function(params) {
                ...
                self.model.save({}, {
                    success: function() {
                        Backbone.trigger(self.masterComponent.componentId + '-' + 'post-contenedorWeb-save', {view: self, model : self.model});
                    },
    ...
    return App.Component._ContenedorWebMasterComponent;
});