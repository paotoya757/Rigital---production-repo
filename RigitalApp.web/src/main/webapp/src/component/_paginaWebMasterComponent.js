define(['controller/selectionController', 'model/cacheModel', 'model/paginaWebMasterModel', 'component/_CRUDComponent', 'controller/tabController', 'component/paginaWebComponent',
 ...
 problemaComponent) {
    App.Component._PaginaWebMasterComponent = App.Component.BasicComponent.extend({
        initialize: function() {
            var self = this;
            ...
            this.masterComponent = new PaginaWebComponent();
            ...
            Backbone.on(this.masterComponent.componentId + '-post-paginaWeb-create', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-post-paginaWeb-edit', function(params) {
                self.renderChilds(params);
            });
            Backbone.on(this.masterComponent.componentId + '-pre-paginaWeb-list', function() {
                self.hideChilds();
            });
            ...
            Backbone.on(this.masterComponent.componentId + '-instead-paginaWeb-save', function(params) {
                ...
                self.model.save({}, {
                    success: function() {
                        Backbone.trigger(self.masterComponent.componentId + '-' + 'post-paginaWeb-save', {view: self, model : self.model});
                    },
    ...
    return App.Component._PaginaWebMasterComponent;
});